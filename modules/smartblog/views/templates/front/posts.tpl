...
<a href="{smartblog::GetSmartBlogLink('smartblog')}">
	{l s='All Blog News' mod='smartblog'}
</a>
		...
		<div class="sdstags-update">
			<span class="tags">
				...
				{foreach from=$tags item=tag}
					...
					<a title="tag" href="{smartblog::GetSmartBlogLink('smartblog_tag',$options)}">
						{$tag.name}
					</a>
				{/foreach}
			</span>
	...
	{if $comment_status == 1}
		<div class="smartblogcomments" id="respond">
			...
			<div id="commentInput">
			  ...
			  <table>			
				<tbody>
					<!--tr>
						...
						<td colspan=2>
							<input type="text" tabindex="1" class="inputName form-control grey" value="{$comment_name}" name="name">
						</td>
					</tr>
					<tr>
						<td>
							<span class="required">*</span> <b>{l s='E-mail:'  mod='smartblog'} </b>
						</td>
						<td>
							<input type="text" tabindex="2" class="inputMail form-control grey" value="{$comment_email}" name="mail">
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<span class="note"> {l s='(Site url with http://)'  mod='smartblog'}</span>
						</td>
					</tr-->
					<tr>
						<td>
							<span class="required">*</span> <b> {l s='Comment:'  mod='smartblog'}</b>
						</td>
						<td colspan=2>
			  ...
			  <input type='hidden' value='{$comment_name}' name='name' />
			  <input type='hidden' value='{$comment_email}' name='mail' />
