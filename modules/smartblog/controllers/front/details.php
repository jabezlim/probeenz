	...
	public function initContent()
	{
		  ...
		  SmartBlogPost::postViewed($id_post);
           ...
           $this->context->smarty->assign(array(											
											...
											'comment_name' => ($this->context->customer->logged ? $this->context->customer->firstname.' '.$this->context->customer->lastname : false),
											'comment_email' => ($this->context->customer->logged ? $this->context->customer->email : false),
