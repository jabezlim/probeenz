		...
		{foreach from=$discounts item=discount name=myLoop}
			<tr class="alternate_item">
				...
				<td class="history_method">
					...
					<a rel="#order_tip_{$discount->id|intval}" class="cluetip" title="{l s='Generated by these following orders' mod='loyalty'}" >{l s='more...' mod='loyalty'}</a>
