...
<div class="graybox" style="line-height:220%">
    ...
    <label for="ex2_input0">우편번호</label>
    <input type="text" id="ex2_input0" class="example_pcfull" value="" />
    <br />
    <label for="ex2_input1">도로명주소</label>
    <input type="text" id="ex2_input1" class="example_input" value="" />
    <br />
    <label for="ex2_input2">상세주소</label>
    <input type="text" id="ex2_input2" class="example_input" value="" />
    <br />
    <label for="ex2_input3">참고항목</label>
    <input type="text" id="ex2_input3" class="example_input" value="" />
    <br />
    <label for="ex2_input4">지번주소</label>
    <input type="text" id="ex2_input4" class="example_input" value="" />
    <br />
    <label for="ex2_input5">영문주소</label>
    <input type="text" id="ex2_input5" class="example_input" value="" />
    <br />
</div>

<script src="//cdn.poesis.kr/post/search.min.js"></script>
<link href="//cdn.poesis.kr/post/search.css" rel="stylesheet" media="all" />
<script type="text/javascript">
    $(function() { $("#postcodify").postcodify({
        insertPostcode6 : "#postcode",
			...
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					...
					<div class="required form-group">
						...
						<input type="text" class="is_required form-control" id="guest_email" name="guest_email" value="{if isset($smarty.post.guest_email)}{$smarty.post.guest_email}{else}guest@probeenz.com{/if}" />
						<div>{l s='you can use guest@probeenz.com when you don\'t use email'}</div>
					</div>
