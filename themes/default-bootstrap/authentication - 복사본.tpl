			...
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					...
					<div class="required form-group">
						...
						<input type="text" class="is_required validate form-control" data-validate="isEmail" id="guest_email" name="guest_email" value="{if isset($smarty.post.guest_email)}{$smarty.post.guest_email}{else}guest@probeenz.com{/if}" />
